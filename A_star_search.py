# This code was generated by OpenAI's ChatGPT language model using the prompt:
# "can you write some python code to perform A* search using an Object-Oriented Approach"
